...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<DataNews>> {
    ...
    public Loader<List<DataNews>> onCreateLoader(int id, @Nullable Bundle args) {
        Uri.Builder uriBuilder = NewsPreferences.getUri(HomeActivity.this);
